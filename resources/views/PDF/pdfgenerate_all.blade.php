...
<head>
    ...
    <style>
        ...
        body {
            ...
            /* Set the maximum width to 8.1 inches */
        }
...
<body>
    @foreach ($researchs as $research)
        ...
        <div
            style=" margin-bottom: 20px; font-size:14px; font-family: 'Times New Roman', Times, serif; padding: 0 50px">
        ...
        <div
            style=" margin-bottom: 45px; font-size:14px; font-family: 'Times New Roman', Times, serif; padding: 0 50px">
