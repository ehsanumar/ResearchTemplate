<x-app-layout>
                        ...
                        <form method="POST" action="{{ route('research.store') }}" enctype="multipart/form-data">
                            ...
                            <div class="mt-4">
                                ...
                                <select id="teacher_name"
                                        ...
                                        name="teacher_name" :value="old('teacher_name')" required
                            ...
                            <div class="mt-4">
                                ...
                                <x-text-input  id="keyword" class="block mt-1 w-full" type="text"
                                              placeholder="Write Main Keywords like this : kurd ,kurdstan , .... "
                                              name="keyword"
                            ...
                            <div class="mt-4">
                                ...
                                <x-input-error :messages="$errors->get('refrence')" class="mt-2"/>
                            </div>
                                            ...
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 font-medium flex ">
                                                    <form
                                                        ...
                                                        @method('delete')
                                                        <button><i
                                                                class="fa-solid fa-trash px-3 text-red-400"></i>
                                                        </button>
                                            ...
                                            <tr
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 font-medium ">
                                                    <form
                                                        ...
                                                        <select id="status" onchange="this.form.submit()"
                                                ...
                                                <td class="whitespace-nowrap px-6 py-4 font-medium ">
                                                    <form
                                                        ...
                                                        @method('PUT')
                                                        <x-text-input
                                                             class=" w-20 text-sm border rounded-md text-gray-700  "
                                                            value="{{ $Research->score }}" type="number" max='100'
                                                            min="0" name="score"/>
                                                        <button>
    ...
    var inputIds = ["student_name", "title", "content", "keyword", "abstract", "refrence"];

    // Loop through each input element ID
    inputIds.forEach(function(id) {
        ...
        inputElement.addEventListener("input", function() {
            ...
            var isArabic = /[\u0600-\u06FF]/.test(inputValue); // Check if the input contains Arabic characters

            if (isArabic) {
                this.style.direction = "rtl"; // Set direction to right-to-left for Arabic
            } else {
                this.style.direction = "ltr"; // Set direction to left-to-right for non-Arabic (assumes English)
            }
        });
    });
</script>
